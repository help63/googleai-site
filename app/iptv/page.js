...
export default function IPTVPage() {
  ...
  return (
    <>
      <AdManager provider="Google AdSense" slot="iptv-top" />
    <main
      style={{
        minHeight: "100vh",
        padding: 24,
